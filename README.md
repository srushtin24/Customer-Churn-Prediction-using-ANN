...
*This repository contains two complete models for predicting customer churn using Artificial Neural Networks (ANN) built with TensorFlow/Keras. The objective is to analyze telecom customer behavior and predict whether a customer will churn or stay. What makes this project strong is that it includes both a baseline ANN model and an enhanced version with imbalanced data handling (SMOTE).* <br>

**Dataset :** https://www.kaggle.com/datasets/blastchar/telco-customer-churn<br><br><br>
...
- Improved ANN model using SMOTE to handle class imbalance<br><br><br>
...
📈 Much better customer churn detection<br>
📈 More business actionable model<br><br>

✔ Churn vs Tenure Distribution<br><br>
<img src="cust_vs_tenure.png" width="500"><br>

✔ Churn vs Monthly Charges<br><br>
<img src="cust_vs_mc.png" width="500"><br>
